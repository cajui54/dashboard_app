              ...
              <tr key={index}>
                ...
                <td>
                  {formatMoneyBR.format(
                    calculateProductWithoutProfit(product.amount, product.price)
                  )}
                </td>
                ...
                <td className="TDProfit">
                  {formatMoneyBR.format(
                    typeof product.profit === "string"
